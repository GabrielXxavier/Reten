...
O sistema analisa dados dos alunos e utiliza um modelo de Random Forest para prever a probabilidade de churn de cada aluno. Ele identifica alunos que ainda estão ativos mas apresentam alto risco de cancelamento.
